...
namespace PCBPlotter.Views
{
    ...
    public partial class ThemedMessageBox : Window
    {
        ...
        private void ConfigureIcon(MessageBoxImage icon)
        {
            ...
            // Note: MessageBoxImage has aliases with same values:
            // Warning = Exclamation = 48, Error = Hand = Stop = 16, Information = Asterisk = 64
            if (icon == MessageBoxImage.Information) // Also Asterisk (64)
            {
                // Info circle icon
            ...
            else if (icon == MessageBoxImage.Warning) // Also Exclamation (48)
            {
            ...
            else if (icon == MessageBoxImage.Error) // Also Hand, Stop (16)
            {
                // Error circle icon
            ...
            else if (icon == MessageBoxImage.Question) // (32)
            {
